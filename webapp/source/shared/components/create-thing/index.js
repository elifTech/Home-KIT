...
class ThingForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    //   })
    // }
    createThing(this.props.type, this.props.type, this.props.session.token, this.props.dispatch)
      .then(result => {
  ...
  render() {
    ...
    return (
      <div className="full-block">
        ...
        <button onClick={this.handleSubmit}>Create things for this item</button>
